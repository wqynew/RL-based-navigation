...
<div align="center">
  <table style="width:100%" border="0">
    ...
    * The action command is converted to the wheel velocity and passed to the robot. For example, the move right action in A is converted to rotate right at ![1](http://latex.codecogs.com/svg.latex?\int_a^bf(x)\ dx) ![](http://latex.codecogs.com/svg.latex?45^\circ/s) for 2s, move forward at 0.25m/s for 2s, and rotate left at 45^\circ/s for 2s. These commands are published with a frequency of 5Hz. It is complex due to the movementdirection restrictions of the TurtleBot.
